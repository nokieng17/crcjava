 ...
 */
public class Crc16 {
	public static AlgoParams Crc16CcittFalse = new AlgoParams(
	...
	public static AlgoParams Crc16AugCcitt = new AlgoParams(
			"CRC-16/AUG-CCITT", 16, 0x1021, 0x1D0F, false, false, 0x0, 0xE5CC
	);
	public static AlgoParams Crc16Buypass = new AlgoParams(
			"CRC-16/BUYPASS", 16, 0x8005, 0x0, false, false, 0x0, 0xFEE8
	);
	public static AlgoParams Crc16Cdma2000 = new AlgoParams(
			"CRC-16/CDMA2000", 16, 0xC867, 0xFFFF, false, false, 0x0, 0x4C06
	);
	public static AlgoParams Crc16Dds110 = new AlgoParams(
	...
	public static AlgoParams Crc16En13757 = new AlgoParams(
			"CRC-16/EN-13757", 16, 0x3D65, 0x0, false, false, 0xFFFF, 0xC2B7
	);
	public static AlgoParams Crc16Genibus = new AlgoParams(
	...
	public static AlgoParams Crc16Mcrf4Xx = new AlgoParams(
	...
	public static AlgoParams Crc16Teledisk = new AlgoParams(
			"CRC-16/TELEDISK", 16, 0xA097, 0x0, false, false, 0x0, 0xFB3
	);
	public static AlgoParams Crc16Tms37157 = new AlgoParams(
